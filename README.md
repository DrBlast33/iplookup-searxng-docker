...
- Edit the [searxng/settings.yml](https://github.com/drblast33/iplookup-searxng-docker/blob/master/searxng/settings.yml) file according to your need
...
Check out the newest version on github: [drblast33/aplookup-searxng-docker](https://github.com/drblast33/aplookup-searxng-docker).
